...
model_file = "/zhoukangkang/old_tipc-opt/ait_examples/vit/model.onnx"
...
io_binding.bind_output(name='1339', device_type=Y_ortvalue.device_name(), device_id=0, element_type=np.float32, shape=Y_ortvalue.shape(), buffer_ptr=Y_ortvalue.data_ptr())
for i in range(100):
